...
(function umd(root, factory) {
  ...
  obtain_grid_settings = function obtain_grid_settings(element) {
  ...
  add_columns = function add_columns(grid, items) {
  ...
  remove_columns = function remove_columns(grid) {
  ...
  recreate_columns = function recreate_columns(grid) {
    // removes all the columns from the grid, and adds them again,
    // it is used when the number of columns change.

    requestAnimationFrame(function render_after_css_media_query_change() {
      add_columns(grid, remove_columns(grid));
    });
  },


  media_query_change = function media_query_change(mql) {
  ...
  get_css_rules = function get_css_rules(stylesheet) {
  ...
  get_stylesheets = function get_stylesheets() {
  ...
  media_rule_has_columns_selector = function media_rule_has_columns_selector(rules) {
  ...
  scan_media_queries = function scan_media_queries() {
  ...
  next_element_column_index = function next_element_column_index(grid) {
  ...
  create_list_of_fragments = function create_list_of_fragments(quantity) {
  ...
  append_elements = function append_elements(grid, elements) {
  ...
  prepend_elements = function prepend_elements(grid, elements) {
  ...
  register_grid = function register_grid (grid) {
